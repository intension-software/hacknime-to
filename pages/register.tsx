  ...
  return (
    <div className='justify-center flex h-screen py-48'>
      <div className="bg-primary-white rounded-2xl pb-12 px-12">
        ...
        <u className='text-black pl-5 py-2'>osobných údajov</u>
        <div className="justify-center flex pt-4"><button className="bg-red-700 p-2 rounded-full border-black border-4 hover:border-opacity-20 hover:border-4 active:border-red-700 active:bg-black">Registrovať sa</button></div>
        </div>
      </div>
    </div>
  )
